  ...
  - id: project-instruction-file
    ...
    providers:
      ...
      google:
        ...
        description: Project-scoped rules stored in .agents/rules at the workspace or git root.
        notes: ''
      openai:
        offering: Codex
        ...
        last_verified: '2026-06-22'
        description: Repository-scoped AGENTS.md applies project-specific norms on top of global defaults.
        notes: ''
  ...
  - id: model-selection
    ...
    providers:
      ...
      openai:
        ...
        evidence_url: https://developers.openai.com/codex/subagents.md
        last_verified: '2026-06-22'
        description: Assign specific models to each agent, either auto-selected or pinned.
        notes: ''
  ...
  - id: mcp-server-management
    ...
    providers:
      ...
      openai:
        ...
        evidence_url: https://developers.openai.com/codex/concepts/customization.md
        last_verified: '2026-06-22'
        description: CLI command to add and manage MCP servers for Codex.
        notes: ''
  - id: mcp-authentication
    ...
    providers:
      anthropic:
        ...
        last_verified: '2026-06-22'
        description: Supports env-var, HTTP header, and OAuth 2/2.1 token-based authentication to MCP servers.
        notes: ''
      google:
        offering: Antigravity
        implementation: unverified
      ...
      openai:
        ...
        last_verified: '2026-06-22'
        description: Authenticates to MCP servers via OAuth using the codex mcp login flow.
        notes: ''
  - id: mcp-tool-governance
    ...
    providers:
      anthropic:
        ...
        evidence_url: https://code.claude.com/docs/en/agent-sdk/mcp.md
        last_verified: '2026-06-22'
        description: Granular permission control over which MCP tools an agent may invoke, including wildcard rules.
        notes: ''
      google:
        offering: Antigravity
        ...
        last_verified: '2026-06-22'
        description: Grants agent access to a single named tool on a specific MCP server.
        notes: ''
      openai:
        offering: Codex
        implementation: unverified
  ...
  - id: plan-mode
    ...
    providers:
      anthropic:
        ...
        last_verified: '2026-06-22'
        description: Researches and proposes changes without executing or modifying anything.
        notes: ''
      google:
        offering: Antigravity
        implementation: unverified
  ...
  - id: parallel-workspaces
    ...
    providers:
      ...
      google:
        ...
        last_verified: '2026-06-22'
        description: Agents operate in dedicated Git worktrees to isolate parallel work within a project.
        notes: ''
      openai:
        offering: Codex
        ...
        last_verified: '2026-06-22'
        description: Each Git-repo automation runs in an isolated worktree to prevent interference.
        notes: ''
  ...
  - id: background-execution
    ...
    providers:
      anthropic:
        ...
        evidence_url: https://code.claude.com/docs/en/sub-agents.md
        last_verified: '2026-06-22'
        description: Run a subagent as a non-blocking background task alongside other operations.
        notes: ''
      google:
        offering: Antigravity
        ...
        evidence_url: https://antigravity.google/assets/docs/cli/cli-subagents.md
        last_verified: '2026-06-22'
        description: Run tracked, long-running operations asynchronously without blocking the primary agent.
        notes: ''
      openai:
        offering: Codex
  ...
  - id: scheduled-runs
    ...
    providers:
      ...
      openai:
        ...
        evidence_url: https://developers.openai.com/codex/app/automations.md
        last_verified: '2026-06-22'
        description: Independent scheduled tasks that run on their own without a conversation thread.
        notes: ''
  ...
  - id: network-egress-control
    ...
    providers:
      anthropic:
        ...
        last_verified: '2026-06-22'
        description: Firewall script restricts outbound network traffic to only explicitly allowed domains.
        notes: ''
      google:
        offering: Antigravity
        ...
        evidence_url: https://antigravity.google/assets/docs/settings/ide-settings.md
        last_verified: '2026-06-22'
        description: Controls network connectivity for sandboxed commands independently of filesystem restrictions.
        notes: ''
      openai:
        offering: Codex
        ...
        evidence_url: https://developers.openai.com/codex/agent-approvals-security.md
        last_verified: '2026-06-22'
        description: Enables or disables outbound network access, optionally scoped to an allowed domain list.
        notes: ''
  ...
  - id: resume-session
    ...
    providers:
      ...
      openai:
        ...
        last_verified: '2026-06-22'
        description: Resume an active Codex session from any signed-in device.
        notes: ''
  ...
  - id: notifications
    ...
    providers:
      anthropic:
        ...
        evidence_url: https://code.claude.com/docs/en/remote-control.md
        last_verified: '2026-06-22'
        description: Sends push alerts to mobile devices for remote session events and updates.
        notes: ''
      google:
        offering: Antigravity
        implementation: unverified
      ...
      openai:
        ...
        evidence_url: https://developers.openai.com/codex/remote-connections.md
        last_verified: '2026-06-22'
        description: Receive alerts when Codex finishes a task or requires user input.
        notes: ''
